...
class UserController extends FOSRestController
{
    ...
    public function updateAction($id, Request $request)
    {
        ...
        elseif(!empty($name) && !empty($role) && !empty($username) && !empty($password)){
            $user->setName($name);
            $user->setRole($role);
        ...
        else return new View("User name or role or username or password cannot be empty", Response::HTTP_NOT_ACCEPTABLE);
    }
    /**
     * @Rest\Delete("/user/{id}")
     */
